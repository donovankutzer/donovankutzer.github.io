          ...
          <Grid.Col span={{ base: 12, md: 5 }}>
            <Stack gap="xl">
              ...
              <Stack gap="md">
                ...
                >
                  <span className="c1" style={{ color: 'var(--text)' }}>JavaScript at C-speed. </span>
                  <span className="c2" style={{ color: 'var(--accent-mint)' }}>No cold starts. </span>
                  <span className="c1" style={{ color: 'var(--text)' }}>No billing shock.</span>
                </Title>
            ...
            <Stack gap="lg" w="100%">
              ...
              >
                ...
                <Flex justify="center" mt="md">
                  ...
                  >
                    View detailed compiler benchmarks
                  </Button>
                </Flex>
              </Paper>
            </Stack>
